        ...
        <div key={todo.id} className="flex justify-between items-center py-2 px-6 border-b border-gray-200">
          ...
          {isEditing && editText.id === todo.id ? (
            ...
            onClick={() => setIsEditing(false)}>
              <svg class="h-8 w-8 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>
            ...
            onClick={() => {
              ...
              {isEditing && editText.id === todo.id ? 'Done' : 
              <svg class="h-8 w-8 text-white" width="24"  height="24"  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
